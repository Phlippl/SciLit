# Datei: D:\DevEnv\DevProjects\SciLit\app.py
import os
...
# Korrigieren Sie den letzten Teil der app.py-Datei
if __name__ == "__main__":
    # Diese Variante funktioniert mit reload=True
    uvicorn.run("app:app", host="0.0.0.0", port=8000, reload=True)
    
    # Alternativ können Sie reload weglassen und die App direkt übergeben
